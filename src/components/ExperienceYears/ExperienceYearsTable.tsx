            ...
            <tr key={rowIndex}>
              {row.map((exp, colIndex) => (
                <td key={colIndex} className="relative group p-4 text-center">
                  <span>
                    <strong>{exp.years}+</strong> {exp.title}
                  </span>
                  <div
                    className="invisible group-hover:visible absolute z-9999 w-max px-3 py-2 text-sm font-medium text-white bg-black rounded-lg shadow-sm 
